...
var layersList = [lyr_GoogleHybrid_0,lyr_KabupatenKudus_1,group_BatasAdministrasi,lyr_JaringanJalanKudus_4,lyr_SupplyKopi_5,lyr_SupplyKelapa_6,lyr_SupplyTebu_7,lyr_DemandTebu_8,lyr_DemandKelapa_9,lyr_DemandKopi_10];
...
lyr_DemandTebu_8.set('fieldAliases', {'Name': 'Nama UMKM', 'KLASIF': 'Klasifikasi', 'JENIS': 'Jenis', 'ALAMAT': 'Alamat', 'JAM': 'Jam Operasional', 'CP': 'Kontak', 'GAMBAR': 'Gambar', 'RATING': 'Rating', });
lyr_DemandKelapa_9.set('fieldAliases', {'Name': 'Nama UMKM', 'KLASIF': 'Klasifikasi', 'JENIS': 'Jenis', 'ALAMAT': 'Alamat', 'JAM': 'Jam Operasional', 'CP': 'Kontak', 'GAMBAR': 'Gambar', 'RATING': 'Rating', });
lyr_DemandKopi_10.set('fieldAliases', {'Name': 'Nama UMKM', 'KLASIF': 'Klasifikasi', 'JENIS': 'Jenis', 'ALAMAT': 'Alamat', 'JAM': 'Jam Operasional', 'CP': 'Kontak', 'GAMBAR': 'Gambar', 'RATING': 'Rating', });
...
lyr_DemandTebu_8.set('fieldImages', {'Name': 'TextEdit', 'KLASIF': 'TextEdit', 'JENIS': 'TextEdit', 'ALAMAT': 'TextEdit', 'JAM': 'TextEdit', 'CP': 'TextEdit', 'GAMBAR': 'TextEdit', 'RATING': 'TextEdit', });
lyr_DemandKelapa_9.set('fieldImages', {'Name': 'TextEdit', 'KLASIF': 'TextEdit', 'JENIS': 'TextEdit', 'ALAMAT': 'TextEdit', 'JAM': 'TextEdit', 'CP': 'TextEdit', 'GAMBAR': 'TextEdit', 'RATING': 'TextEdit', });
lyr_DemandKopi_10.set('fieldImages', {'Name': 'TextEdit', 'KLASIF': 'TextEdit', 'JENIS': 'TextEdit', 'ALAMAT': 'TextEdit', 'JAM': 'TextEdit', 'CP': 'TextEdit', 'GAMBAR': 'TextEdit', 'RATING': 'TextEdit', });
lyr_KabupatenKudus_1.set('fieldLabels', {'NAMA_DESA': 'no label', 'NAMA_KEC': 'no label', 'Sup Kelapa': 'no label', });
...
lyr_DemandTebu_8.set('fieldLabels', {'Name': 'no label', 'KLASIF': 'no label', 'JENIS': 'no label', 'ALAMAT': 'no label', 'JAM': 'no label', 'CP': 'no label', 'GAMBAR': 'no label', 'RATING': 'no label', });
lyr_DemandKelapa_9.set('fieldLabels', {'Name': 'no label', 'KLASIF': 'no label', 'JENIS': 'no label', 'ALAMAT': 'no label', 'JAM': 'no label', 'CP': 'no label', 'GAMBAR': 'no label', 'RATING': 'no label', });
lyr_DemandKopi_10.set('fieldLabels', {'Name': 'no label', 'KLASIF': 'no label', 'JENIS': 'no label', 'ALAMAT': 'no label', 'JAM': 'no label', 'CP': 'no label', 'GAMBAR': 'no label', 'RATING': 'no label', });
